//package com.lotus.learn.thinkinginjava.generics;//: generics/WatercolorSets.java
//import static com.lotus.learn.thinkinginjava.net.mindview.util.Print.print;
//import static com.lotus.learn.thinkinginjava.net.mindview.util.Sets.complement;
//import static com.lotus.learn.thinkinginjava.net.mindview.util.Sets.difference;
//import static com.lotus.learn.thinkinginjava.net.mindview.util.Sets.intersection;
//import static com.lotus.learn.thinkinginjava.net.mindview.util.Sets.union;
//
//import java.util.EnumSet;
//import java.util.Set;
//
//import com.lotus.learn.thinkinginjava.generics.watercolors.Watercolors;
//
