	...
	private ActionListener al = new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			...
			if (id.equals("Alert"))
				...
				int sel = JOptionPane.showOptionDialog(null, "Choose a Color!", "Warning", JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE,
				...
				Object val = JOptionPane.showInputDialog(null, "Choose one", "Input", JOptionPane.INFORMATION_MESSAGE, null, selections,
						selections[0]);
				if (val != null)
