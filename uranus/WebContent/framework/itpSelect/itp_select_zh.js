...
ZTEMulitSelectV1D0D0D0.ShowWinForm = function(ctlName,dts) {
    var k = ctlName.document.getElementById(ctlName.id + "_input");
    var v = ctlName.document.getElementById(ctlName.id + "_value");
...
var itpSelectDiv = null;
	...
	*/
	function itpSelectCtrlShow(id)
	{
		...
		var width = (labelObj.getAttribute("width")||150);
		...
		if(MulitSelect == "True" || MulitSelect == "true")
		{
		    ...
		    html += "<textarea id='" + textareaId + "' rows='" + Rows + "' readonly='readonly' style='cursor:pointer;width: " + width + "' onclick=\"ZTEMulitSelectV1D0D0D0.searchinput('" + id + "','search')\"></textarea>";
