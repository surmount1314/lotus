...
if (dts[15] == "Dept") {
    if (dts[14] == "True") {
        js_include(itpSelectPath + "lang/depten.js");
    }
    else {
        js_include(itpSelectPath + "lang/deptcn.js");
    }
}
else if (dts[15] == "Employee") {
    if (dts[14] == "True") {
        js_include(itpSelectPath + "lang/employeeen.js");
    }
    else {
        js_include(itpSelectPath + "lang/employeecn.js");
    }
}
else {
    if (dts[14] == "True") {
        js_include(itpSelectPath + "lang/en.js");
    }
}
if (dts[16] != "") {
    js_include(dts[16]);
